...
namespace UrbanAirship
{
	...
	interface UAChannel
	{
		...
		void FetchSubscriptionListsWithCompletionHandler (Action<NSArray<NSString>, NSError> completionHandler);
	...
	interface UAMessageCenterInbox
	{
		...
		void GetMessagesWithCompletionHandler (Action<NSArray> completionHandler);
	...
	interface UAMessageCenterViewControllerFactory
	{
		...
		UIViewController MakeWithTheme ([NullAllowed] UAMessageCenterTheme theme, [NullAllowed] IUAMessageCenterPredicate predicate);
		...
		[return: NullAllowed]
		UIViewController MakeWithThemePlist ([NullAllowed] string themePlist, [NullAllowed] IUAMessageCenterPredicate predicate, [NullAllowed] out NSError error);
		...
		UIView EmbedWithTheme ([NullAllowed] UAMessageCenterTheme theme, [NullAllowed] IUAMessageCenterPredicate predicate, UIViewController parentViewController);
	}
