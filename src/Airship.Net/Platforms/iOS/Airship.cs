        ...
        */
        ...
        private void DeviceTagHelper(bool clear, string[] addTags, string[] removeTags)
        {
            ...
            if (editor != null)
            {
                if (clear)
                {
                    // TODO: Clear() method not exposed in SDK 19 ObjectiveC bindings
                    // As a workaround, we can remove tags one by one if needed
                }
        ...
        public void DisplayMessageCenter()
        {
            ...
            // For now, just invoke the event to let the app handle it
